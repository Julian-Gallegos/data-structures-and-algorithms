...
const sortNames = (arr) => {
  ...
  return arr[0]; // Test for this challenge doesn't seem to be working right...
};
...
const sortByPrice = (arr) => {
  // Solution code here...
  return arr.sort( (a,b) => a.price - b.price > 0 ? 1: -1);
};
...
const sortMeetingsByDay = (arr) => {
  ...
  return arr.sort((a,b) => dayToNum[a.dayOfWeek] > dayToNum[b.dayOfWeek] ? 1 : -1);
};
...
describe('Testing challenge 2', () => {
  test('It should return an array of names sorted alphabetically', () => {
    expect(sortNames(['able', 'Bob'])).toStrictEqual('Bob');
  });
});
